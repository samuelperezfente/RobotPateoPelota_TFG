...
class LidarFilterWithBoundingBox(Node):
    ...
    def pointcloud_callback(self, msg):
        ...
        camera_rotation_matrix_z = np.array([camera_rotation_matrix_z[0], camera_rotation_matrix_z[1], camera_rotation_matrix_z[2]])

        # Corrige permutando el eje Y y Z
        camera_forward = np.array([fwd_raw[0], fwd_raw[1], fwd_raw[2]])
