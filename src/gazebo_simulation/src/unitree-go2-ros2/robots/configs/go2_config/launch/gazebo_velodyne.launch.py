...
def generate_launch_description():
    ...
    default_world_path = os.path.join(config_pkg_share, "worlds/Room_ball_goal.world")
    ...
    # Incluir el archivo de YOLO para el reconocimiento
    ...
    # Incluir el launch de ball_kicking
    ball_kicking_ld = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("ball_kicking"),
                "launch",
                "ball_kicking.launch.py",
            )
        ),
        launch_arguments={
            "use_sim_time": LaunchConfiguration("use_sim_time"),
